namespace SHD.KPSA.Tools.Utils
{
    ...
    public class ObservableObject : INotifyPropertyChanged
    {
        ...
        /// <summary>
        /// Returns whether an exception is thrown, or if a Debug.Fail() is used when an invalid property name is passed
        /// to the VerifyPropertyName method. The default value is false, but subclasses used by unit tests might
