namespace SHD.KPSA.Tools.Utils.ListSelection
{
    ...
    public class TwoListSynchronizer : IWeakEventListener
    {
        ...
        /// The type of the <see cref="T:System.Windows.WeakEventManager" /> calling this
        /// method.
        /// </param>
        ...
        /// listener
        /// does not handle. Regardless, the method should return false if it receives an event that it does not
        /// recognize or
        /// handle.
        /// </returns>
