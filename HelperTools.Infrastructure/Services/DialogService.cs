namespace HelperTools.Infrastructure.Services
{
    ...
    /// <summary>This class provides different dialogs.</summary>
    public class DialogService
    {
        /// <summary>Gave the (own) possible error variations to choose from.</summary>
        public enum ExceptionType
        {
            /// <summary>The generic variation.</summary>
            Universal,

            /// <summary>The variant for data access problems.</summary>
            FileAcces
        }

        /// <summary>Displays a dialog of error messages.</summary>
        ...
        /// <summary>Displays a warning dialog when completing a Processing.</summary>
        ...
        /// <summary>Provides a dialog to select a folder available.</summary>
        ...
        /// <summary>Displays a dialog of showing the current process.</summary>
        ...
        /// <summary>Displays a dialog as completion of processing.</summary>
        /// <param name="sumFiles">The number of files processed.</param>
