namespace HelperTools.Infrastructure.Converter
{
    ...
    /// <summary>An implementation of <see cref="IValueConverter" /> that converts the casing of the input string.</summary>
    ...
    /// <see cref="Casing" /> property. Setting <see cref="Casing" /> is a shortcut for setting both <see cref="SourceCasing" /> and
    /// <see cref="TargetCasing" />. It is therefore possible to specify that the source and target properties be converted to
    /// different casings.
    /// </remarks>
    /// <example>
    ...
    {
        #region Constructor
        /// <summary>Initializes a new instance of the CaseConverter class.</summary>
        ...
        #region Properties
        /// <summary>Initializes a new instance of the CaseConverter class with the specified source and target casings.</summary>
