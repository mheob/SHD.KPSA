namespace HelperTools.Infrastructure.Converter
{
    ...
    /// </summary>
    /// <remarks>
    /// The <c>BoolToVisibleConverter</c> class can be used to convert boolean values (or values that can be converted to
    /// boolean values) to <see cref="Visibility" /> values. By default, <see langword="true" /> is converted to
    /// <see cref="Visibility.Visible" /> and
    /// <see langword="false" /> is converted to <see cref="Visibility.Hidden" />. However, the <see cref="Collapse" /> property can
    /// be set to <see langword="true" /> in order to return
    /// <see cref="Visibility.Collapsed" /> instead of <see cref="Visibility.Hidden" />. In addition, the <see cref="Reverse" />
    /// property can be set to <see langword="true" /> to reverse the returned values.
    /// </remarks>
    ...
    public class BoolToVisibleConverter : BaseConverter, IValueConverter
    {
        ...
        /// <summary>Gets and sets the option for reversing the boolean parameter.</summary>
        /// <value>
        ...
        public object ConvertBack(object value, Type targetType, object parameter, CultureInfo culture)
        {
            ...
            if (visibility == Visibility.Visible) return !Reverse;
