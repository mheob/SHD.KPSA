namespace SHD.KPSA.Utils
{
    ...
    /// <summary>
    /// Converter class for colors.
    /// </summary>
    public class AdditionalColorConverter
    {
        /// <summary>
        /// Get the RGB values using a HEX color.
        /// </summary>
        ...
        /// <summary>
        /// Gets the RGB values using an image file.
        /// </summary>
        ...
        /// <summary>
        /// Get the RGB values back using a SolidColorBrush.
        /// </summary>
        ...
        /// <summary>
        /// Converts a SolidColorBrush into a SolidBrush.
        /// </summary>
        /// <param name="br">The color as SolidColorBrush.</param>
