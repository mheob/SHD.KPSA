namespace SHD.KPSA.Utils.Converter
{
    ...
    public class ColorToStringConverter : BaseConverter, IValueConverter
    {
        #region Enum
        /// <summary>
        /// An enumeration with the choices of color display.
        /// </summary>
        public enum ColorDisplay
        {
            /// <summary>
            /// The color as hexadecimal.
            /// </summary>
            Hex,

            /// <summary>
            /// The Red part of the RGB.
            /// </summary>
            Red,

            /// <summary>
            /// The Green part of the RGB.
            /// </summary>
            Green,

            /// <summary>
            /// The Blue part of the RGB.
            /// </summary>
            Blue
        }
        #endregion Enum
        ...
        #region Constructor
        /// <summary>
        /// Initialize a new instance of the ColorToStringConverter class.
        /// </summary>
        ...
        /// <summary>
        /// Converts a <see cref="Color" /> to a <see cref="string" />.
        /// </summary>
        ...
        /// <returns>
        /// A converted <see cref="string" />. If the method returns null, the valid null value is used.
        /// </returns>
        ...
        /// <summary>
        /// Converts a <see cref="string" /> back to <see cref="Color" />.
        /// </summary>
        ...
        public object ConvertBack(object value, Type targetType, object parameter, CultureInfo culture)
        {
            ...
            var rgb = AdditionalColorConverter.GetRgbfromHex(color);
