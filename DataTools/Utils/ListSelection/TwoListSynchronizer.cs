...
namespace DataTools.Utils.ListSelection
{
    /// <summary>
    ...
    public class TwoListSynchronizer : IWeakEventListener
    {
        ...
        /// <see cref="T:System.Windows.WeakEventManager" /> handling in WPF�to register a listener for an event that the listener
